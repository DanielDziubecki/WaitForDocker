...
namespace WaitForDocker.Config
{
    internal static class Extensions
    {
            ...
            IEnumerable<ServicePort> servicePorts)
        {
            ...
            config.HealthCheckers.AddRange(defaltHealthChecksPorts.Select(x => new TcpHealthChecker(x.Port, DockerConsts.DockerServiceCheckTimeout, x.Name, null, config.Logger)));
        }
    }
}